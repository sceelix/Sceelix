...
#include "References/Lighting.fxh"
#include "References/Material.fxh"
#include "References/Fog.fxh"

#define CLAMP_TEXCOORDS_TO_SHADOW_MAP_BOUNDS 1
#include "References/ShadowMap.fxh"
...
#if !SM4 && !SKINNING && !MORPHING && !POINT_LIGHT_COUNT && !SPOTLIGHT_COUNT && !PROJECTOR_LIGHT_COUNT && !ENVIRONMENT_TEXTURE && !MGFX
