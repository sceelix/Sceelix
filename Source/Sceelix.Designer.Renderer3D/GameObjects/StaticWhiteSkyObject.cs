...
namespace Sceelix.Designer.Renderer3D.GameObjects
{
    ...
    public class StaticWhiteSkyObject : GameObject
    {
        ...
        public StaticWhiteSkyObject(IServiceLocator services)
        {
            _services = services;
            Name = "StaticWhiteSky";
            SkyExposure = 0.2f;
        ...
        protected override void OnLoad()
        {
            ...
            //_skyboxNode = new SkyboxNode(content.Load<TextureCube>("Deferred/Sky2"))
            //_skyboxNode = new SkyboxNode(content.Load<TextureCube>("Textures/SimpleSky"))
            /*{
            ...
            _sunlightNode = new LightNode(sunlight)
            {
                ...
                PoseWorld = new Pose(QuaternionF.CreateRotationY(1.4f)*QuaternionF.CreateRotationX(-0.9f)), //-0.6f
                ...
                Shadow = new CascadedShadow
                {
                    ...
                    PreferredSize = 1024,
                    /*DepthBias = new Vector4F(0.99f),
                    
                    //Distances = new Vector4F(),
                    MinLightDistance = 5,
                    ShadowFog = 0.5f,
            ...
            var lensFlareTexture = content.Load<Texture2D>("Deferred/LensFlare/LensFlares");
