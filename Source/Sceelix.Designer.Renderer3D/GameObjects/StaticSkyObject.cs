...
namespace Sceelix.Designer.Renderer3D.GameObjects
{
    ...
    public class StaticSkyObject : GameObject
    {
        ...
        protected override void OnLoad()
        {
            ...
            //_skyboxNode = new SkyboxNode(content.Load<TextureCube>("Deferred/Sky2"))//Textures/SkyTexCube01
            /*_skyboxNode = new SkyboxNode(content.Load<TextureCube>("Textures/SimpleSky"))
            {
                Color = new Vector3F(SkyExposure),
                //PoseLocal = new Pose(Matrix33F.CreateRotationX(ConstantsF.PiOver2))
            ...
            var sunlight = new DirectionalLight
            {
                ...
                HdrScale = 0.35f, //previously: 0.4f or now: 0.35
                DiffuseIntensity = 1,
                SpecularIntensity = 1,
            };
