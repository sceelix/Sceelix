...
namespace Sceelix.Designer.Renderer3D.GraphicsScreens
{
    ...
    public class CustomSceneQuery : ISceneQuery
    {
        ...
        public List<SceneNode> DecalNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> LensFlareNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> SkyNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> FogNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> RenderableNodes
        {
            get;
            private set;
        }
