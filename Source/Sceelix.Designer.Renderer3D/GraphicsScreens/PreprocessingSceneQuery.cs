...
namespace Sceelix.Designer.Renderer3D.GraphicsScreens
{
    ...
    public class PreprocessingSceneQuery : ISceneQuery
    {
        ...
        public List<SceneNode> TerrainNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> CloudLayerNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> WaterNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> SceneCaptureNodes
        {
            get;
            private set;
        }
        ...
        public List<SceneNode> PlanarReflectionNodes
        {
            get;
            private set;
        }
