...
using Sceelix.Designer.Renderer3D.GameObjects.FogSphere;
using Sceelix.Designer.Renderer3D.GameObjects.VolumetricLight;
using Sceelix.Designer.Renderer3D.PostProcessing;
...
namespace Sceelix.Designer.Renderer3D.GraphicsScreens
{
    ...
    class DeferredGraphicsScreen : GraphicsScreen, IDisposable, ICustomGraphicsScreen
    {
        //--------------------------------------------------------------
        ...
        public SceneCaptureRenderer SceneCaptureRenderer
        {
            get;
            private set;
        }
        ...
        public ShadowMaskRenderer ShadowMaskRenderer
        {
            get;
            private set;
        }
        ...
        public LightBufferRenderer LightBufferRenderer
        {
            get;
            private set;
        }
        ...
        public SceneRenderer AlphaBlendSceneRenderer
        {
            get;
            private set;
        }
        ...
        public PostProcessorChain PostProcessors
        {
            get;
            private set;
        }
        ...
        public bool VisualizeIntermediateRenderTargets
        {
            get;
            set;
        }
        ...
        public DeferredGraphicsDebugMode DebugMode
        {
            get;
            set;
        }
        ...
        {
            var contentManager = services.Get<ContentManager>();
            ...
            _reticle = contentManager.Load<Texture2D>("Deferred/Reticle");
            ...
            bool doPostProcessing, bool renderLensFlares, bool renderDebugOutput, bool renderReticle)
        {
            ...
            graphicsDevice.DepthStencilState = DepthStencilState.DepthRead;
            graphicsDevice.BlendState = BlendState.AlphaBlend;
            _figureRenderer.Render(sceneQuery.RenderableNodes, context, RenderOrder.BackToFront);
